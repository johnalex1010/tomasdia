    ...
    <div class="site-section testimonial-wrap custom-owl-carousel" id="">
      <div class="container">
        <div class="row text-center justify-content-center mb-5"  data-aos="fade-up">
            <h1 class="section-title w-100 mx-auto">Nuevo Usuario</h1>
        </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp" name="nombres" value="<?php echo trim($_POST['nombres']) ?>" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="" class="h4 text-secondary">Email</label>
                    <small class="text-danger"><?php echo $error[2]; ?></small>
                    <input type="email" class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<?php echo trim($_POST['email']) ?>" autocomplete="off">
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="" cols="30" rows="5" class="form-control form-control-sm" name="usuario" value="<?php echo trim($_POST['usuario']) ?>" autocomplete="off"/>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <button type="submit" class="btn btn-secondary float-right" name="submit-user">Crear usuario</button>
                </div>
              </div>                  
            </div>
          </div>
